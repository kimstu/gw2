...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"首页",sLast:"末页",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"没有数据可以显示",sInfo:"当前显示第 <span>_START_</span> 条至第 <span>_END_</span> 条数据，共计 <span>_TOTAL_</span> 条数据",sInfoEmpty:"当前显示第 <span>0</span> 条至第 <span>0</span> 条数据，共计 <span>0</span> 条数据",sInfoFiltered:"(从 <span>_MAX_</span> 条数据中筛选)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"单页显示条数 _MENU_ ",sLoadingRecords:"加载中...",sProcessing:"处理中...",sSearch:"查询或筛选:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"未检索到相关数据"},
